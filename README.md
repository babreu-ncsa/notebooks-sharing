...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/babreu-ncsa/notebooks-sharing/HEAD?urlpath=lab)
 
**Insert a MyBinder.org launch link for the [4-Predict.ipynb](notebooks/4-Predict.ipynb) notebook.**

*[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/babreu-ncsa/notebooks-sharing/HEAD?filepath=notebooks%2F4-Predict.ipynb)*
